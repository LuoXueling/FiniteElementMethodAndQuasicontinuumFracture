function save_deformed_vtk_file(datpath,iLoad,nodeCoordRef,elemNodeNo,elemCfg,projectCfg,disp_n1,velo_n1,acce_n1,result)
...
%Open file
fname=strcat(datpath,'/','deformed_time_',num2str(iLoad),'.vtk');
out=fopen(fname,'w');
