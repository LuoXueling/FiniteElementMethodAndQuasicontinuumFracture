...
projectCfg.boundaryCfgFrom='script'; 
...
projectCfg.QC=true;
projectCfg.networkFilename='QC-3-dense-net';
projectCfg.QCfullyDiscrete=false;
projectCfg.QCrefineAroundNotch=true;
projectCfg.cantRefineBelow=10;
projectCfg.meshRefine=true;
projectCfg.fracture=true;
...
computeCfg.disp=5*64;

computeCfg.staticVelo=16; %mm/s
computeCfg.dynamicVelo=computeCfg.staticVelo/10;
computeCfg.staticPvelo=8; %MPa/s
computeCfg.dynamicPvelo=1000;

computeCfg.staticDt=0.1;
computeCfg.dynamicDt=0.1;
...
computeCfg.vtkStep=1;
computeCfg.vtkDeformedStep=1;
